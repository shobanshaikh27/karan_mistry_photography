...
// import gallerytitle from '@/assets/images/gallerytitle.png'
export const ParallaxScroll = ({ images, className }) => {
  ...
  return (
    <div
      ...
      ref={gridRef}
    >
      {/* <h2 className="text-3xl font-bold text-primary text-center absolute top- left-1/2 -translate-x-1/2">Image Gallery</h2> */}
      <div
